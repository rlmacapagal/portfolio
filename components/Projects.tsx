...
function Projects({ projects }: Props) {
  ...
  return (
    <motion.div
      ...
      className="h-screen relative flex  flex-col text-left md:flex-row max-w-full justify-evenly
    ...
    >
      ...
      <div
        className="relative w-full h-[98%] flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20
